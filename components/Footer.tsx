      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-purple-600 dark:text-purple-400 mb-4">Flow State Webpanel</h3>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <ul className="text-sm text-gray-500 dark:text-gray-500 mt-2 md:mt-0">Coded with ❤️ by JKE 
            <li className="text-sm text-gray-500 dark:text-gray-500 mt-2 md:mt-0">Further Developed by FlowState</li>
            </ul>
          </div>
        </div>
      </div>
